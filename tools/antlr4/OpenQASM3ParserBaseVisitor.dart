...
class OpenQASM3ParserBaseVisitor<T> extends ParseTreeVisitor<T>
    implements OpenQASM3ParserVisitor<T> {
  ...
  /// [visitChildren] on [ctx].
  @override
  T? visitOldStyleDeclarationStatement(
  ...
  /// [visitChildren] on [ctx].
  @override
  T? visitDefcalArgumentDefinitionList(
