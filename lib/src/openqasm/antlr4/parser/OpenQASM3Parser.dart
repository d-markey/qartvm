...
// ignore_for_file: unused_import, unused_local_variable, prefer_single_quotes, constant_identifier_names, non_constant_identifier_names, file_names
          ...
          switch (interpreter!.adaptivePredict(tokenStream, 44, context)) {
            case 1:
              _localctx = PowerExpressionContext(
                ExpressionContext(_parentctx, _parentState),
              );
...
class StatementOrScopeContext extends ParserRuleContext {
  ...
  @override
  void enterRule(ParseTreeListener listener) {
    if (listener is OpenQASM3ParserListener) {
