...
class ControlledGateBuilder {
  ...
  ComplexMatrix squareRootOfX(Set<int> qubits, {required Set<int> controls}) =>
      _cache.putIfAbsent(
        'SQRTX-${_key(controls)}->${_key(qubits)}',
  ...
  ComplexMatrix phase(
    ...
    'PHASE-$radians-${_key(controls)}->${_key(qubits)}',
